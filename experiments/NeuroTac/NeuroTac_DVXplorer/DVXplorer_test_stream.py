...
def make_meta(meta_file, 
              sensor = 'DVXplorer', # Sensor type: DAVIS240, eDVS or DVXplorer           
  ...
  with make_sensor() as sensor:
    ...
    for trial_idx in range (n_trials):
      ...
      for pose_idx in range(n_poses):
        ...
        events_stream_file = os.path.join(data_dir,'trial_' +str(trial_idx) +'_pose_'  + str(pose_idx) + '_events_stream.h5')

        sensor.save_events_stream(events_stream_file)
