...
def make_meta (robot_tcp = [0, 0, 115, 0, 0, 0], # Size of the TacTip (tcp = tool center point)
              ...
              work_frame = [446, -78, 100, 180, 0, 180], # Starting point and reference frame for this experiment -36
              linear_speed = 10, # Robot's speed for linear movements
              angular_speed = 20, # Robot's speed for rotation movements
              tap_move = [[0, 0, 4, 0, 0, 0], [0, 0, 0, 0, 0, 0]],   # Sequence of positions for the tap relative to the robot's current pose (positive z goes down)
