...
def make_meta(robot_tcp = [0, 0, 119.5, 0, 0, 70],
              ...
              work_frame = [383, -257, 188, 180, 0, -160], # (383, -257, 280, 180, 0, 0), (383, -257, 180, 180, 0, -135) for old tactip
              linear_speed = 20,
              angular_speed = 10,
...
def make_sensor_in():
    return NeuroTac(save_events_video=True, save_acc_video=True)    
            ...
            for speed in slide_speeds:
                for depth in slide_depths:
                    for direction in slide_directions:
                        ...
                        sensor_in.set_filenames(events_on_file = events_on_file, events_off_file = events_off_file, events_video_file = events_video, acc_video_file = acc_video)
