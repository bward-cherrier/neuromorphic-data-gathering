...
def main():
    ...
    test_meta_file = os.path.join(home_dir, 'collect_tap_rand_efi_02031304', 'meta.json')
    model_meta_file = os.path.join(home_dir, r'collect_tap_rand_efi_02031105\models\train_dnn_02040708\meta.json')
