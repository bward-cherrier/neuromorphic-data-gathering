...
def make_model_meta(meta_file, train_meta_file, valid_meta_file,
                    ...
                    lr = 1e-4,
                    decay = 1e-6,
                    loss_weights = [1/4**2, 1/15**2, 1/15**2],
...
def main():
    ...
    train_meta_file = os.path.join(home_dir, 'collectTapRand3d05071937\meta.json')
    valid_meta_file = os.path.join(home_dir, 'collectTapRand3d05071938\meta.json')
