...
train_meta_file = os.path.join('edge5d', 'collect5d_rand_03191010', 'version5', 'meta.json')
valid_meta_file = os.path.join('edge5d', 'collect5d_rand_03191010', 'version6', 'meta.json')                                         
