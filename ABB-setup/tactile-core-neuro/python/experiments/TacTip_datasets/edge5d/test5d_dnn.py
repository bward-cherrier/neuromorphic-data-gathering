...
def main():
    ...
    test_meta_file = os.path.join('edge5d', 'collect5d_rand_03091459', 'version4', 'meta.json')
    model_meta_file = os.path.join('edge5d', 'collect5d_rand_03091020', 'version4', 'models', 'train5d_dnn_03151238', 'meta.json')
    ...
    pred_df.to_csv(os.path.join(home_dir, os.path.dirname(test_meta_file), 'predictions.csv'))
    fig = plot_pred(pred_df, **meta)
    fig.savefig(os.path.join(home_dir, os.path.dirname(meta_file), 'errors.png'), bbox_inches='tight')   
