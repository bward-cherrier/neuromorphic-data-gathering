...
def main():
    ...
    train_meta_file = os.path.join(home_dir, 'collect2d_rand_02042234', 'meta.json')
    valid_meta_file = os.path.join(home_dir, 'collect2d_rand_02042234', 'meta.json')                                            
