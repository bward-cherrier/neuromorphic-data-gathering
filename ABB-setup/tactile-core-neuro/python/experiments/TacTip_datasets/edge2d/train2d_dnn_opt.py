...
def main():
    ...
    train_meta_file = os.path.join('edge2d', 'collect2d_rand_03202159', 'version1', 'meta.json')
    valid_meta_file = os.path.join('edge2d', 'collect2d_rand_03202159', 'version2', 'meta.json')                                         
