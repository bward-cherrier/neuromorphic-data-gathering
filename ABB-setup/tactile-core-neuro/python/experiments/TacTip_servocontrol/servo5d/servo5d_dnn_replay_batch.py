...
#    replay_dir = os.path.join('servo5d') # [next...[4]]    
#    replay_dir = os.path.join('servo5d')    
#    replay_dir = os.path.join('servo5d', 'disk', 'rX')    
#    replay_dir = os.path.join('servo5d', 'disk', 'rY')    
#    replay_dir = os.path.join('servo5d', 'disk', 'rZ')    
#    replay_dir = os.path.join('servo5d', 'disk', 'rPhi')    
#    replay_dir = os.path.join('servo5d', 'disk', 'rPsi')    
#    replay_dir = os.path.join('servo5d', 'disk', 'rTheta')
#    poses_path = os.path.join(home_dir, 'servo5d', 'disk', 'poses.csv')
#    replay_dir = os.path.join('servo5d', 'lid')
#    replay_dir = os.path.join('servo5d', 'saddle')
#    poses_path = os.path.join(home_dir, 'servo5d', 'saddle', 'posesSurface.csv')
    replay_dir = os.path.join('servo5d', 'wave')
    poses_path = os.path.join(home_dir, 'servo5d', 'wave', 'posesSurface.csv')
#    poses_path = os.path.join(home_dir, 'servo5d', 'servo5d_dnn_03221711', 'poses.csv')    
    ...
    for file in next(os.walk(os.path.join(home_dir, replay_dir)))[1]:
        ...
        meta['model_file'] = os.path.join(home_dir, 'servo5d', 'model', 'model.h5')      
...
#        meta['target_poses'][:,1] = -meta['target_poses'][:,1] # Hack for wave
        meta['target_poses'] = meta['target_poses'] - np.array([15,5,2,0,0,0]) # Hack for wave #        
