...
from servo3d_dnn import control_dnn
...
#name = r'sphere/rXY'; var1 = 'r'; val1 = [[np.cos(i), np.sin(i), 3, 0, 0, 0] for i in np.arange(0,2*np.pi,np.pi/4)]
#var2 = 'num_steps'; val2 = [65,]*8
#name = r'sphere/rZ'; var = 'r'; val = [[0, 1, v, 0, 0, 0] for v in np.arange(1, 5, 0.5)]
#name = r'sphere/rPhi'; var = 'r'; val = [[0, 3, 3, 5*i, 0, 0] for i in range(-3,4)]
#name = r'sphere/rPsi'; var = 'r'; val = [[0, 1, 3, 0, 5*i, 0] for i in range(-3,4)]
#name = r'sphere/rTheta'; var = 'r'; val = [[0, 1, 3, 0, 0, 15*i] for i in range(-2,3)]

name = r'brain/rXY'; var1 = 'r'; val1 = [[np.cos(i), np.sin(i), 3, 0, 0, 0] for i in np.arange(0,2*np.pi,np.pi/4)]
var2 = 'num_steps'; val2 = [50, 40, 30, 40, 50, 40, 30, 40]

meta_dir = os.path.join('..', 'TacTip_servocontrol', 'servo3d', name)
...
#    meta['target_rng'] = [[-20, -20, -3, -20, -20, -np.inf], [20, 20, 10, 30, 30, np.inf]]
