...
def main():
    ...
    test_meta_file = os.path.join(home_dir, 'collectTapRand2d05072204\meta.json')
    model_meta_file = os.path.join(home_dir, r'collectTapRand2d05072203\models\trainDNNopt_12070749\meta_278.json')
