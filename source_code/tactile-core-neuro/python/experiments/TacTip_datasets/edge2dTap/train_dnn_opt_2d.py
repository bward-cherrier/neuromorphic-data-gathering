...
from experiments.TacTip_datasets.train_dnn_opt import make_model_meta, build_objective_func, make_trials_df, plot_trials

def main():
    # Specify directories and files - to edit
    home_dir = os.path.join(os.environ['DATAPATH'], 'TacTip_datasets\edge2dTap')
    train_meta_file = os.path.join(home_dir, 'collectTapRand2d05072203\meta.json')
    valid_meta_file = os.path.join(home_dir, 'collectTapRand2d05072204\meta.json')
