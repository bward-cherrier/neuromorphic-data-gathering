...
from test5d_dnn import plot_pred, make_test_meta


def main():    
    # Specify directories and files - to edit
    home_dir = os.path.join(os.environ['DATAPATH'], 'TacTip_datasets')
    test_meta_file = os.path.join('edge5d', 'collect5d_rand_03201048', 'version0', 'meta.json')
    ...
    for j, trial in enumerate(trials_rng[:5]):
        ...
        try:
            ...
            fig.savefig(os.path.join(home_dir, test_dir, 'error_'+str(j+1)+'.png'), bbox_inches='tight')   
