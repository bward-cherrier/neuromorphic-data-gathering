...
train_data_dir = os.path.join(data_root_dir, r"TacTip-datasets\plane3dTap\collectTapRand3d05071937")
train_image_dir = os.path.join(train_data_dir, "images")
train_df_file = os.path.join(train_data_dir, "targets_image.csv")
train_df = pd.read_csv(train_df_file)

valid_data_dir = os.path.join(data_root_dir, r"TacTip-datasets\plane3dTap\collectTapRand3d05071938")
