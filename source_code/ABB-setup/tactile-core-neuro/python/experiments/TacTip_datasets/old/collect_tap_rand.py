...
from vsp.video_stream import CvVideoCamera, CvImageOutputFileSeq, CvVideoDisplay #, CvVideoOutputFile
...
def collect_tap(video_dir, video_df_file, num_frames, tap_move, robot_tcp, ip,
