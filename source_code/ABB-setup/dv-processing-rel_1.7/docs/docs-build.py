...
git_current = re.sub(r'[^a-zA-Z-_\d]', '_', git_current)
git_default = re.sub(r'[^a-zA-Z-_\d]', '_', git_default)
git_doc_tags = [re.sub(r'[^a-zA-Z-_\d]', '_', t) for t in git_doc_tags]
git_doc_branches = [re.sub(r'[^a-zA-Z-_\d]', '_', b) for b in git_doc_branches]
