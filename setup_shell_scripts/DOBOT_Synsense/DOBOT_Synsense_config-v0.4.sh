...
echo "Please input your virtual environment name (or press Enter to use default name: dobot_env):"
read ENV_NAME
ENV_NAME=${ENV_NAME:-'dobot_env'}
...
echo -e "\nDobot and Synsense environment is successfully configured!"
